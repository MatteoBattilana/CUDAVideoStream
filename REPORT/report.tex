...
/*00e8*/ LD.E.128 R8, [R12]; \end{lstlisting}
	...
	At this point, the \textit{nvprof} profiler is run and the results are shown in Table \ref{tab:nvprof_naif6} and is noticeable a really big improvement, reducing the kernel time by another 60\%. The average fps are 26, with a \textit{for} time of 4.7 ms and a \textit{read} time of 37 ms. The overall comparison is shown in Figure \ref{fig:chart6}.
